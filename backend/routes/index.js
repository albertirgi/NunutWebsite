...
import { storeTransaction, getAllTransactions, getAllTransactionsByList, getTransactionById, updateTransaction, destroyTransaction } from '../controllers/Transaction.js';
import { topup, handleTopup, topup2, getTransaction, getTransactionByWallet, getTransactionByWalletByList, getWalletBalance } from '../controllers/Midtrans.js';
...
router.get('/transaction/:num', getAllTransactionsByList);
...
router.post('/get-transaction-by-wallet/list/:num', getTransactionByWalletByList);
